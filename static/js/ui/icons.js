...
// Marks of the six rating sources, kept as bare paths so the sort dropdown and
// the dialog's rating row draw the exact same ones. IMDb, TMDb, Rotten Tomatoes,
// Trakt and Metacritic are their official wordmarks; the audience score has no
// separate wordmark, so it is drawn as the popcorn bucket Rotten Tomatoes shows
// it with - which is also what keeps it apart from the tomatometer beside it.
const RATING_LOGO_PATHS = {
    ...
    rt_audience: '<path fill-rule="evenodd" clip-rule="evenodd" d="M4 9.4h16l-1.3 12a1.8 1.8 0 0 1-1.79 1.6H7.09A1.8 1.8 0 0 1 5.3 21.4L4 9.4Zm4.62 2.1.4 9h2.23l-.26-9H8.62Zm5.39 0-.26 9h2.23l.4-9h-2.37Z"/><circle cx="7.6" cy="6.4" r="2.5"/><circle cx="12" cy="4.6" r="2.7"/><circle cx="16.4" cy="6.4" r="2.5"/><circle cx="12" cy="7.8" r="2.2"/>',
    trakt: '<path d="m15.082 15.107-.73-.73 9.578-9.583a4.499 4.499 0 0 0-.115-.575L13.662 14.382l1.08 1.08-.73.73-1.81-1.81L23.422 3.144c-.075-.15-.155-.3-.25-.44L11.508 14.377l2.154 2.155-.73.73-7.193-7.199.73-.73 4.309 4.31L22.546 1.86A5.618 5.618 0 0 0 18.362 0H5.635A5.637 5.637 0 0 0 0 5.634V18.37A5.632 5.632 0 0 0 5.635 24h12.732C21.477 24 24 21.48 24 18.37V6.19l-8.913 8.918zm-4.314-2.155L6.814 8.988l.73-.73 3.954 3.96zm1.075-1.084-3.954-3.96.73-.73 3.959 3.96zm9.853 5.688a4.141 4.141 0 0 1-4.14 4.14H6.438a4.144 4.144 0 0 1-4.139-4.14V6.438A4.141 4.141 0 0 1 6.44 2.3h10.387v1.04H6.438c-1.71 0-3.099 1.39-3.099 3.1V17.55c0 1.71 1.39 3.105 3.1 3.105h11.117c1.71 0 3.1-1.395 3.1-3.105v-1.754h1.04v1.754z"/>',
...
export const SORT_ICONS = {
    ...
    rt_audience: `<svg viewBox="0 0 24 24" fill="currentColor">${RATING_LOGO_PATHS.rt_audience}</svg>`,
    trakt:       `<svg viewBox="0 0 24 24" fill="currentColor">${RATING_LOGO_PATHS.trakt}</svg>`,
...
// The one thing per season that crosses the screen rather than falling through
// it: Santa's sleigh at Christmas, a witch at Halloween (see ui/season-effects.js).
// Both are drawn facing right, since both cross from left to right, and both are
// built from plain shapes so they carry their own colours on a dark page - a flat
// silhouette disappears into it.
export const SEASON_FLYERS = {
    christmas: `<svg viewBox="0 0 268 104" fill="none" aria-hidden="true">
        <g stroke="#a06a2c" stroke-width="2.5" stroke-linecap="round">
            <path d="M104 52c22-8 44-10 62-6"/>
        </g>
        <g fill="#7a4a2b" opacity="0.8">
            <ellipse cx="152" cy="52" rx="21" ry="10"/>
            <path d="M170 46c8-5 14-4 16-1 2 3 0 7-4 9l-11 3z"/>
        </g>
        <g stroke="#7a4a2b" stroke-width="3" stroke-linecap="round" opacity="0.8">
            <path d="M138 60l-5 15M148 62l-2 15M160 62l4 15M168 59l7 14M182 40l-2-10M182 40l7-7M188 34l7-2"/>
        </g>
        <g fill="#8b5a2b">
            <ellipse cx="206" cy="46" rx="22" ry="11"/>
            <path d="M225 39c9-5 15-4 17-1 2 4 0 8-4 10l-12 3z"/>
        </g>
        <g stroke="#8b5a2b" stroke-width="3.5" stroke-linecap="round">
            <path d="M191 55l-6 16M202 57l-2 16M214 57l5 16M223 54l8 15M238 33l-3-11M238 33l8-8M245 26l8-3"/>
        </g>
        <circle cx="248" cy="41" r="3" fill="#f05555"/>
        <path d="M18 70c4 9 15 13 34 13h32c9 0 14-4 14-13V52c0-7-4-9-11-7L34 57c-10 2-16 7-16 13z" fill="#c1121f"/>
        <path d="M12 86c18 7 66 7 90 0" stroke="#e0b23a" stroke-width="3.5" stroke-linecap="round"/>
        <path d="M96 52c0-10 6-16 14-14" stroke="#c1121f" stroke-width="7" stroke-linecap="round"/>
        <g>
            <path d="M52 66c-2-12 3-20 12-20s13 8 12 20z" fill="#d92b32"/>
            <circle cx="64" cy="38" r="9" fill="#f0c9a0"/>
            <path d="M55 34c1-8 5-12 10-12 6 0 10 5 10 12z" fill="#d92b32"/>
            <circle cx="76" cy="24" r="3.5" fill="#f4f6fb"/>
            <path d="M55 34h20" stroke="#f4f6fb" stroke-width="3.5" stroke-linecap="round"/>
            <path d="M56 46c4 3 12 3 16 0" stroke="#f4f6fb" stroke-width="3" stroke-linecap="round"/>
            <path d="M74 54c8-2 18-3 28-4" stroke="#f0c9a0" stroke-width="4" stroke-linecap="round"/>
        </g>
        <g fill="#f8d489" opacity="0.75">
            <circle cx="8" cy="60" r="2.5"/><circle cx="0" cy="72" r="1.8"/><circle cx="14" cy="44" r="1.6"/>
        </g>
    </svg>`,
    halloween: `<svg viewBox="0 0 240 120" fill="none" aria-hidden="true">
        <g stroke="#c98c3c" stroke-width="3.5" stroke-linecap="round">
            <path d="M24 84L2 70M24 86L0 84M24 88L4 100M26 90L14 108"/>
        </g>
        <path d="M22 78l16-3 2 12-16 3z" fill="#8a5a24" transform="rotate(-12 30 81)"/>
        <path d="M24 86L214 47" stroke="#a06a2c" stroke-width="6" stroke-linecap="round"/>
        <path d="M150 38C120 34 92 46 68 74l28 12c22-14 42-24 56-26z" fill="#4c1d95"/>
        <path d="M146 44c-24-2-46 8-66 30" stroke="#6d28d9" stroke-width="3" opacity="0.6"/>
        <g stroke="#2e1065" stroke-width="6" stroke-linecap="round">
            <path d="M146 62l-10 26M156 64l-6 26"/>
        </g>
        <g fill="#2e1065">
            <path d="M130 86l16-4 4 12-18 4z"/>
            <path d="M142 88l16-4 4 12-18 4z"/>
        </g>
        <ellipse cx="152" cy="48" rx="17" ry="15" fill="#5b21b6"/>
        <path d="M158 46c10 0 20 2 28 6" stroke="#5b21b6" stroke-width="7" stroke-linecap="round"/>
        <circle cx="170" cy="28" r="12" fill="#a7d977"/>
        <path d="M180 28l14 5-14 5z" fill="#8fc466"/>
        <circle cx="174" cy="23" r="2" fill="#1f1235"/>
        <path d="M164 21c4-3 8-3 11 0" stroke="#6f9c46" stroke-width="2" stroke-linecap="round"/>
        <path d="M152 15h36L186 0z" fill="#2e1065"/>
        <path d="M148 17h44" stroke="#2e1065" stroke-width="7" stroke-linecap="round"/>
        <path d="M156 14h26" stroke="#f59e0b" stroke-width="3.5"/>
        <g fill="#4a3566">
            <path d="M46 30c5-5 10-5 13 0 3-5 8-5 13 0-5 6-10 7-13 3-3 4-8 3-13-3z"/>
            <path d="M14 46c4-4 8-4 10 0 2-4 6-4 10 0-4 5-8 5-10 2-2 3-6 3-10-2z"/>
        </g>
    </svg>`
};
